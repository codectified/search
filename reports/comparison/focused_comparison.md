...
| **Mixedbread dirty** | `hadithText` full text | ✗ | Semantic HNSW (mxbai-embed-large) | 50 → 10 |
...
**Latency:** **BM25 Lexical (full text)** 67ms · **Mixedbread (dirty — full hadithText)** 900ms · **Mixedbread (clean matn)** 96ms · **English OpenAI small (clean matn)** 1031ms · **English OpenAI large (clean matn)** 403ms · **Arabic OpenAI (small)** 893ms · **Arabic OpenAI (large)** 233ms · **E5 Multilingual** 335ms  
...
<th width="32%">Mixedbread (dirty — full hadithText)</th>
...
**Latency:** **BM25 Lexical (full text)** 55ms · **Mixedbread (dirty — full hadithText)** 128ms · **Mixedbread (clean matn)** 130ms · **English OpenAI small (clean matn)** 237ms · **English OpenAI large (clean matn)** 903ms · **Arabic OpenAI (small)** 195ms · **Arabic OpenAI (large)** 291ms · **E5 Multilingual** 177ms  
