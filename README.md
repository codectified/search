...
The active model(s) are declared in `EMBEDDING_MODELS` in `main.py`. Model selection is under active evaluation — see `tests/small_model_comparison.py` for the comparison script.
